(() => {
    ...
    updateSlidesProgress: function (e) {
      ...
      for (let e = 0; e < i.length; e += 1) {
        ...
        f && (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(e)),
          ...
          D(l, m, s.slideFullyVisibleClass),
          (l.progress = r ? -c : c),
  ...
  function U(e) {
    ...
    if (u > n.longSwipesMs) {
      ...
      "next" === t.swipeDirection &&
        (y >= n.longSwipesRatio
          ? t.slideTo(n.rewind && t.isEnd ? w : m + T)
          : t.slideTo(m)),
        "prev" === t.swipeDirection &&
          (y > 1 - n.longSwipesRatio
            ? t.slideTo(m + T)
            : null !== S && y < 0 && Math.abs(y) > n.longSwipesRatio
            ? t.slideTo(S)
            : t.slideTo(m));
    } else {
  ...
  const ue = document.querySelectorAll(".pl-func"),
    pe = document.querySelectorAll(".pr-func");
  let he;
  function me() {
    (he = window.innerWidth < 1630 ? 15 : (window.innerWidth - 1600) / 2),
      ue.length &&
        ue.forEach((e) => {
          e.style.paddingLeft = he + "px";
        }),
      pe.length &&
        pe.forEach((e) => {
          e.style.paddingRight = he + "px";
        });
  }
  me(), (document.body.onresize = me);
  const fe = document.querySelector(".video__video-box"),
    ge = document.querySelector(".video__decor"),
    ve = fe.querySelector("video");
  async function we() {
    try {
      const e = "0xc02319DE41B61A392b27b6B647e9d6B758237A05";
  ...
  fe.onclick = () => {
    fe.classList.contains("play")
      ? (fe.classList.remove("play"), ge.classList.remove("play"), ve.pause())
      : (ge.classList.add("play"), fe.classList.add("play"), ve.play());
  };
